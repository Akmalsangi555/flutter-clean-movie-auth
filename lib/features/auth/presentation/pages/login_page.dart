...
class _LoginPageState extends State<LoginPage> {
  ...
  void initState() {
    super.initState();
    // Auto-logout if user is authenticated (from browser back navigation)
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (!_hasCheckedAuth && controller.isAuthenticated.value) {
        _hasCheckedAuth = true;
        // Silent logout without showing snackbar
